...
def create_train_state(model, rng, learning_rate, momentum, image_shape):
    """Creates an initial `TrainState`."""
    params = model.init(rng, jnp.ones([1, *image_shape]))['params'] # initialize parameters by passing a template image
